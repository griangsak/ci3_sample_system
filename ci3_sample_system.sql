...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 13, 2019 at 01:53 PM
...
CREATE TABLE `tbl_district` (
  ...
  `district_code` int(6) DEFAULT NULL,
...
(5068, 490197, '*นิคมคำสร้อย   ', 561, 37, 3),
...
(5766, 550905, '*นาไร่หลวง   ', 641, 43, 1),
(5767, 550906, '*ชนแดน   ', 641, 43, 1),
(5768, 550907, '*ยอด   ', 641, 43, 1),
...
(5927, 570406, '*ต้า   ', 660, 45, 1),
(5928, 570407, '*ป่าตาล   ', 660, 45, 1),
(5929, 570408, '*ยางฮอม   ', 660, 45, 1),
...
(5976, 570714, '*เทอดไทย   ', 663, 45, 1),
(5977, 570715, '*แม่สลองใน   ', 663, 45, 1),
...
(6200, 601111, '*แม่เล่ย์   ', 693, 47, 2),
(6201, 601112, '*แม่วงก์   ', 693, 47, 2),
(6202, 601113, '*วังซ่าน   ', 693, 47, 2),
(6203, 601114, '*เขาชนกัน   ', 693, 47, 2),
(6204, 601115, '*ปางสวรรค์   ', 693, 47, 2),
...
(6359, 620512, '*ถาวรวัฒนา   ', 713, 49, 2),
...
(8862, 380102, 'บึงโขงหลง', 999, 77, 3),
...
(8868, 380108, 'โป่งเปื่อย', 999, 77, 3),
...
(8913, 380803, 'หนองเดิน', 1006, 77, 3);
...
CREATE TABLE `tbl_menu` (
  ...
  `menu_level` varchar(5) DEFAULT NULL,
  `menu_controllers` varchar(50) NOT NULL,
  `menu_function` varchar(50) NOT NULL,
  `menu_p1` varchar(50) NOT NULL COMMENT 'parameter1',
  `menu_p2` varchar(50) NOT NULL COMMENT 'parameter2',
  `menu_p3` varchar(50) NOT NULL COMMENT 'parameter3',
  `menu_refid` varchar(10) DEFAULT NULL,
  `menu_sort` int(11) DEFAULT NULL,
  `menu_st` int(11) NOT NULL,
  `menu_system` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tbl_menu` (`menu_id`, `menu_code`, `menu_name`, `menu_level`, `menu_controllers`, `menu_function`, `menu_p1`, `menu_p2`, `menu_p3`, `menu_refid`, `menu_sort`, `menu_st`, `menu_system`) VALUES
(1, '', 'Login', '1', 'systems', 'login', '', '', '', NULL, 0, 1, 'backend'),
(2, 'icon-stats-dots', 'Dashboard', '1', 'dashboard', '', '', '', '', NULL, 0, 0, 'backend'),
(3, 'icon-cog7', 'System Setup', '1', 'systems', '', '', '', '', '', 2, 0, 'backend'),
(4, '', 'Menu', '2', 'systems', 'menu', 'show', '', '', '3', 0, 0, 'backend'),
(5, '', 'Add Menu', '3', 'systems', 'menu', 'add', '', '', '4', 0, 1, 'backend'),
(6, '', 'Edit Menu', '3', 'systems', 'menu', 'edit', '', '', '4', 0, 1, 'backend'),
(7, '', 'Remove Menu', '3', 'systems', 'menu', 'remove', '', '', '4', 0, 1, 'backend'),
(8, '', 'Users', '2', 'systems', 'users', 'show', '', '', '3', 0, 0, 'backend'),
(9, '', 'Add User', '3', 'systems', 'users', 'add', '', '', '8', 0, 1, 'backend'),
(10, '', 'Edit User', '3', 'systems', 'users', 'edit', '', '', '8', 0, 1, 'backend'),
(11, '', 'Remove User', '3', 'systems', 'users', 'remove', '', '', '8', 0, 1, 'backend'),
(13, '', 'My Account', '2', 'systems', 'profile', 'show', '', '', '3', 0, 0, 'backend'),
(20, '', 'Edit Permissions User', '3', 'systems', 'users', 'editper', '', '', '8', 3, 1, 'backend');
...
CREATE TABLE `tbl_permissions` (
  ...
  `pm_privilege` text NOT NULL,
  `pm_system` varchar(10) NOT NULL
...
INSERT INTO `tbl_permissions` (`pm_id`, `user_id`, `pm_privilege`, `pm_system`) VALUES
(1, '2', '1,2,3,4,5,6,7,13', 'backend');
...
CREATE TABLE `tbl_personal` (
  ...
  `per_code_expired` date DEFAULT NULL,
  `per_prefix` varchar(10) DEFAULT NULL,
  ...
  `per_sex` varchar(2) DEFAULT NULL,
  `per_address` text,
  `district_id` varchar(10) DEFAULT NULL,
  `amphur_id` varchar(10) DEFAULT NULL,
  `province_id` varchar(10) DEFAULT NULL,
  `zipcode` varchar(10) DEFAULT NULL,
  `per_tel` varchar(50) DEFAULT NULL,
  `per_email` varchar(100) DEFAULT NULL,
  `per_picture` text,
  `per_status` varchar(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
INSERT INTO `tbl_personal` (`per_id`, `per_code`, `per_code_expired`, `per_prefix`, `per_name`, `per_surname`, `per_nickname`, `per_birthdate`, `per_sex`, `per_address`, `district_id`, `amphur_id`, `province_id`, `zipcode`, `per_tel`, `per_email`, `per_picture`, `per_status`) VALUES
(1, '1-5407-00064-82-0', '2027-05-03', NULL, 'Griangsak', 'Wilawan', NULL, '1992-05-04', 'M', '315 หมู่ 1', '1259', '158', '12', '21180', '085-085-5236', 'griangsak.w@outlook.com', '82a67dced1c989801f88fd4d6b002c93.jpg', '0'),
(2, NULL, NULL, NULL, 'Web', 'Deverloper', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'griangsak.wil@gmail.com', 'e85f0723715cb2b0f26045947c53014f.jpg', '0');
...
INSERT INTO `tbl_user` (`user_id`, `user_name`, `user_password`, `per_id`, `usertype_id`, `user_status`) VALUES
(1, 'admin', 'dc483e80a7a0bd9ef71d8cf973673924', '1', '1', '0'),
(2, 'employee', 'dc483e80a7a0bd9ef71d8cf973673924', '2', '2', '0');
...
CREATE TABLE `tbl_usertype` (
  ...
  `usertype_code` char(3) DEFAULT NULL,
  `usertype_name` varchar(50) DEFAULT NULL,
  `usertype_type` varchar(5) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
INSERT INTO `tbl_usertype` (`usertype_id`, `usertype_code`, `usertype_name`, `usertype_type`) VALUES
(1, 'A', 'Administrator', 'E'),
(2, 'EMP', 'Employee', 'E');
